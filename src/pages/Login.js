    ...
    return (
        <div className="flex min-h-screen flex-col px-6 py-28 lg:px-8">
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
                ...
                <Link to={'/admin'} className="font-semibold leading-6 text-orange-600 hover:text-orange-500">
                    ADMIN ?
                </Link>
            </p>
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p className="mt-10 text-center text-sm text-gray-500">
                    <span>or  </span>
                    <Link className="font-semibold leading-6 text-orange-600 hover:text-orange-500" to={'/signup'}>
                        Sign Up
                    </Link>
                </p>
            </div>
